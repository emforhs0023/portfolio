...
router.get("/api/imgList", (req, res, next) => {
	const params = req.query.params
	
	db.imgList(params, (result) => {
		res.send(result)
	})
	
})

router.get("/api/dataBaseList", (req, res, next) => {
	const params = req.query.params
	
	db.dataBaseList(params, (result) => {
		res.send(result)
	})
	
})

router.get("/api/webServerList", (req, res, next) => {
	const params = req.query.params
	
	db.webServerList(params, (result) => {
		res.send(result)
	})
	
})

router.get("/api/clientList", (req, res, next) => {
	const params = req.query.params
	
	db.clientList(params, (result) => {
		res.send(result)
	})
