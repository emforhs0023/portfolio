...
const smartList = [{"seq":"0", "text":"html5.png"}, {"seq":"1","text":"css.png"},{"seq":"2", "text":"jquery.png"}, {"seq":"3","text":"js.png"}, {"seq":"4","text":"mysql.png"}, {"seq":"5","text":"node.png"}];
const smart = [{"seq":"0", "text":"logo.png"}];

const kpopList = [{"seq":"0", "text":"html5.png"}, {"seq":"1","text":"css.png"}, {"seq":"2","text":"js.png"}, {"seq":"3","text":"react.png"}, {"seq":"4","text":"redux.png"}, {"seq":"5","text":"reduxSaga.png"}, {"seq":"6","text":"next.png"},  {"seq":"7","text":"mysql.png"}, {"seq":"8","text":"node.png"}];
const kpop = [{"seq":"0", "text":"logo.png"}];

const DetailPresenter = ({ seq, projectName, text, thumbnail, participants, engagement, contentImg, backImg, firstDate, lastDate, git }) => {
	const { project, loading, architecture } = useSelector(state => state.user);
				...
				<Content>
					...
					<Data>
						...
						<div style={{clear: "both", marginBottom: "10px"}}>
							<h4 className="participantsZoon">참여 인원 : </h4> <span className="participantsZoon">{participants}</span>
						</div>
						...
						<div>
							<div style={{ marginTop:"10px" }}>
								{architecture == null ? null :
									<div>
										<h1 style={{ marginBottom:"10px" }}>구성</h1>
										<DetailImg params={params}/>
									</div>
								}
							</div>
							<div style={{ marginTop:"10px" }}>
								<div style={{ width: "33.3%", margin: "0 auto", float: "left"}}>
									<Client params={params}/>
								</div>
								<div style={{ width: "33.3%", margin: "0 auto", float: "left"}}>
									<WebServer params={params}/>
								</div>
								<div style={{ width: "33.3%", margin: "0 auto", float: "left"}}>
						...
						<ItemContainar>
							...
							{projectName == "스마트펙토리" &&(
								<Production>
									{smart.map(data => (
										<Image  key={data.seq} bgUrl={data.text ? require('../../assets/smart/'+ `${data.text}`) :  require("../../assets/noPosterSmall.png")}/> 
									))}	
								</Production>
							)}
							{projectName == "Kpop" &&(
								<Production>
									{kpop.map(data => (
										<Image  key={data.seq} bgUrl={data.text ? require('../../assets/kpop/'+ `${data.text}`) :  require("../../assets/noPosterSmall.png")}/> 
									))}	
								</Production>
							)}
						</ItemContainar>
